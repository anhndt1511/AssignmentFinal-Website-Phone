            ...
            <div class="container">
               <div id="sequence">
                  ...
                  <ul class="sequence-canvas">
                     <li class="animate-in">
                        <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead">Siêu Phẩm 2017</span></div>
                        <div class="flat-caption caption2 formLeft delay400 text-center">
                           <h1>Iphone 7 Plus Red</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500 text-center">
                           <p>Cận cảnh iPhone 7 Plus đỏ tại VN: Độc, đẹp, giá cao</p>
                        </div>
                     ...
                     <li>
                        <div class="flat-caption caption2 formLeft delay400">
                           <h1>Review Iphone 6s</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500">
                           <h2>24 giờ trải nghiệm iPhone 6s của một người dùng Android</h2>
                        </div>
                     ...
                     <li>
                        <div class="flat-caption caption2 formLeft delay400 text-center">
                           <h1>Iphone 7 Plus Jet Black</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500 text-center">
                           <p>IPhone 7 Plus: Xứng danh vua smartphone</p>
                        </div>
                        <div class="flat-button caption4 formLeft delay600 text-center"><a class="more" href="#">Xem thêm</a></div>
         ...
         <div class="container_fullwidth">
            <div class="container">
               <div class="hot-products">
                  <h3 class="title"><strong>Hot</strong> Sản phẩm</h3>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/small/6white.png" width="180" height="250" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 6 White 16gb</div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/small/6plus3.png" width="180" height="250" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 6 Plus Trắng/Xám/Hồng</div>
                                 <h4 class="price">$451.00</h4>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/small/ip7.png" width="180" height="250" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 7 Jet Black</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                  <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/small/ip7plus.png" width="180" height="250" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 7 Plus Jet Black 128GB</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">iPets</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
               ...
               <div class="featured-products">
                  <h3 class="title"><strong> Sản Phẩm</strong> Tương Lai</h3>
                     ...
                     <li>
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                   <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/ipet.png" width="500" height="480" alt="Product Name"></a></div>
                                 <div class="productname">iPets</div>
                                 <h4 class="price">$</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                   <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/iplay.png" width="500" height="480" alt="Product Name"></a></div>
                                 <div class="productname">iPlay</div>
                                 <h4 class="price">$</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/iCycle.png" alt="Product Name"></a></div>
                                 <div class="productname">iCycle</div>
                                 <h4 class="price">$</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                   <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/iSight.png" alt="Product Name"></a></div>
                                 <div class="productname"> iSight</div>
                                 <h4 class="price">$</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                  ...
                  <ul id="braldLogo">
                     <li>
                        <ul class="brand_item">
                           <li>
                              <a href="#">
                                 <div class="brand-logo"><img src="images/envat.png " width="370"  height="40"  alt=""></div>
                              </a>
                           </li>
                           <li>
                              <a href="#">
                           ...
                           <li>
                              <a href="#">
                                 <div class="brand-logo"><img src="images/activeden.png" width="370"  height="40" alt=""></div>
                              </a>
                           </li>
                           <li>
                              <a href="#">
